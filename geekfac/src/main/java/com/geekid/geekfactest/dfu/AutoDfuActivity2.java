 ...
 */
public class AutoDfuActivity2 extends Activity implements LoaderCallbacks<Cursor>
{
	...
	private void showFileTransferSuccessMessage()
	{
		...
		showToast("升级成功！");
		AlertDialog a = new AlertDialog.Builder(AutoDfuActivity2.this).setMessage("升级成功！").setPositiveButton("确定", new OnClickListener()
		{
			@Override
			public void onClick(DialogInterface dialog, int which)
			{
				AutoDfuActivity2.this.finish();
			}
		}).create();
		a.show();
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		if (keyCode == KeyEvent.KEYCODE_BACK)
		{
			if (isUploading)
			{
				AlertDialog a = new AlertDialog.Builder(AutoDfuActivity2.this).setMessage("正在升级之中，要退出升级吗？")
